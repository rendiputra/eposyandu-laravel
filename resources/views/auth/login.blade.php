...
@endsection
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-white" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="{{url('/')}}"><img class="d-inline-block me-3" src="{{ asset('asset/img/LogoEposyandu3.png') }}" alt="E-Posyandu" style="height: 41px;"/>E-Posyandu</a>
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <p class="caption-text">
            Silahkan log in menggunakan akun yang<br/>
            telah terdaftar pada website.
          </p>
          ...
          <form style="margin-top: 1.5rem" method="POST" action="{{ route('login') }}">
            ...
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input 
                  class="input-field border-0 @error('nik') is-invalid @enderror" 
                  placeholder="NIK ..."
                  required 
                  id="nik" 
                  type="number"
          ...
          <p class="text-center bottom-caption">
            ...
            <span class="green-bottom-caption">Silahkan untuk meminta admin mendaftarkan akunmu.</span>
          </p>
        </div>
      </div>
    </div>
