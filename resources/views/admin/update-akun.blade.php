...
<section class="content">
  <div class="container-fluid">
      <div class="card">
        ...
        <form action="{{ route('admin.update_akun_act', $data->id) }}" enctype="multipart/form-data" method="POST">
          <div class="card-body">
            @csrf
            ...
            <div class="form-group">
              ...
              <select 
                ...
                <option value="3" @if ($data->role == "3" ) selected @endif>Kades</option>
...
<section class="content">
  <div class="container-fluid">
      <div class="card">
        ...
        <form action="{{ route('admin.update_password_act', $data->id) }}" enctype="multipart/form-data" method="POST">
          <div class="card-body">
            @csrf
            <div class="form-group">
