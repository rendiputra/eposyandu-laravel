  ...
  <div class="container-fluid">
    {{-- <div class="card card-default color-palette-box"> --}}
      <div class="card">
        ...
        <div class="card-body">
          <a href="{{ route('admin.tambah_artikel') }}" class="btn btn-primary mb-3"><i class="fa-solid fa-pen-to-square"></i> Tulis Artikel</a>
                  ...
                  <tr>
                    ...
                    <td class="text-center"> 
                      ...
                      <a type="submit" class="mt-2 btn btn-danger" onclick="if (confirm('Apakah anda yakin menghapus artikel {{ $d->title }}?')) { 
                        ...
                        document.getElementById('delete-data{{ $d->id_artikel }}').submit(); 
                      }"> <i class="fa-solid fa-trash-can"></i> Hapus </a> 
                      <form id="delete-data{{ $d->id_artikel }}" action="{{ route('admin.delete_artikel', $d->id_artikel) }}" method="POST" style="display: none;">
                        @csrf
                      </form> 
                    </td>
                  </tr>
