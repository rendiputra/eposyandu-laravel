...
@section('title')
    Tambah Data Pemeriksaan lansia
@endsection
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Tambah Data Pemeriksaan lansia</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
      <div class="card">
        ...
        <form action="{{ route('kader.periksa_lansia_act') }}" enctype="multipart/form-data" method="POST">
          @csrf
          <input type="hidden" name="id_lansia" value="{{ $data->id_lansia }}"/>
          <div class="card-body">
